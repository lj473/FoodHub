...
class Ui_loginScr(object):
    def setupUi(self, loginScr):
        ...
        self.passLaout = QtWidgets.QVBoxLayout()
        self.passLaout.setObjectName("passLaout")
        ...
        self.passLaout.addWidget(self.lblPass)
        ...
        self.passLaout.addWidget(self.editboxPass)
        self.credentialLayout.addLayout(self.passLaout, 1, 0, 1, 1)
